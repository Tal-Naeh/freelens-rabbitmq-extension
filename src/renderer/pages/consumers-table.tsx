  ...
  return (
    ...
    >
      <Renderer.Component.TableHead sticky={false} nowrap>
        {showQueue ? <Renderer.Component.TableCell sortBy="queue">Queue</Renderer.Component.TableCell> : null}
        <Renderer.Component.TableCell sortBy="tag">Consumer tag</Renderer.Component.TableCell>
        <Renderer.Component.TableCell sortBy="connection">Channel / connection</Renderer.Component.TableCell>
        <Renderer.Component.TableCell>Peer</Renderer.Component.TableCell>
        <Renderer.Component.TableCell>User</Renderer.Component.TableCell>
        <Renderer.Component.TableCell sortBy="prefetch" className="RmqNum">
          Prefetch
        </Renderer.Component.TableCell>
        <Renderer.Component.TableCell>Flags</Renderer.Component.TableCell>
      ...
      {consumers.map((c) => (
        <Renderer.Component.TableRow key={`${c.channelName}|${c.consumerTag}`} sortItem={c} nowrap>
          ...
          <Renderer.Component.TableCell title={c.consumerTag}>
            <span className="RmqMono RmqEllipsis">{c.consumerTag}</span>
          </Renderer.Component.TableCell>
          <Renderer.Component.TableCell title={c.channelName}>
